              ...
              <div class="branding-data clearfix">
                <div class="logo-img">
                  <a href="${baseURL}" rel="home" title="GBIF Logo" class="active">
                    <img src="${baseURL}/styles/logo_biota1.png" />
                  </a>
                </div>
...
[#if sideMenuEml!false]
			...
			<div class="clearfix" id="sidebar">
				...
				<ul class="sidebar">
				[#list ["basic","parties", "keywords", "additionalP", "project", "taxcoverage", "geocoverage", "tempcoverage", "collections", "methods", "additionalI", "physical", "citations"] as it]
